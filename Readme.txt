...
1.	Multi country selection and comparison: 
...
2.	Removal of missing values: 
		We have removed the empty GCI values of the country for a particular year. This helped us scaling the ranges of y scale’s global competitive index in a better way.

3.	Custom Data Viewing: 
		We can view a particular year’s data by typing year in the textbox provided and hitting on the [Search] button.

4.	Country trails of previous years: 
...
5.	Individual Country Data Visualisation: 
